...
CRITICAL = [
    ...
    "安全账户", "洗钱",  # 公检法 (fake police/court) scams move money to a "safe account"
    # English (UK scams)
...
SCAM = [
    ...
    "下载app", "陌生链接", "点击链接", "医保认证", "退款客服", "账户异常",
    "冻结", "中奖", "客服", "解冻", "理赔", "注销", "征信", "贷款",
    # Chinese — fake authority (公检法)
    "公检法", "通缉", "涉嫌", "配合调查", "公安局", "法院传票", "逮捕令",
    # Chinese — investment / job (刷单) scams
    "稳赚不赔", "高收益", "限时返利", "内幕消息", "导师", "跟单", "刷单",
    "垫付", "佣金", "返利", "投资群",
    # English (UK smishing / impersonation)
    "royal mail", "dpd", "evri", "parcel", "redelivery", "hmrc", "tax refund",
    "rebate", "suspended", "verify", "click", "your account", "hi mum",
    "hi dad", "new number", "dvla", "vehicle tax", "energy rebate", "ofgem",
    "unusual activity", "confirm your identity", "reactivate", "customs fee",
    "unpaid", "outstanding payment",
    # English — tech-support / remote-access / prize / investment scams
    "download this app", "download the app", "share your screen", "screen share",
    "remote access", "remote", "gift card", "claim now", "you have won",
    "free iphone", "free gift", "lottery", "prize", "bitcoin", "crypto",
    "guaranteed return", "double your money",
]

# --- HEALTH terms: supplement / wellness exaggeration. Light weight (+1) ---
HEALTH = [
    "包治百病", "根治", "清血管", "血管垃圾", "排毒", "祖传秘方", "专家推荐",
    "不用吃药", "降压药有害", "糖尿病治愈", "买三送三", "限时优惠",
    "保健品", "养生", "特效", "无副作用",
    # more Chinese wellness / supplement exaggeration
    "抗癌", "偏方", "净化血液", "酸碱体质", "干细胞", "提高免疫力",
    "量子", "通经络", "包好", "神药",
    # English wellness / supplement exaggeration
    "detox", "cures", "cure-all", "miracle", "natural remedy", "no side effects",
    "anti-aging", "boost immune", "fat-burning", "reverse aging", "superfood",
]
